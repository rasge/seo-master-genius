...
Collect page evidence (read_url_content first, scripts optional).
Analyze with LLM using explicit proof for each finding.
Apply confidence labels (Confirmed, Likely, Hypothesis).
